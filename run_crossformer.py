...
from common.model_crossformer import *
...
################ load weight ########################
# posetrans_checkpoint = torch.load('./checkpoint/best_epoch_gt_28.5.bin', map_location=lambda storage, loc: storage)
...
if not args.evaluate:
    ...
    # optimizer = optim.SGD(model_pos_train.parameters(), lr = lr, weight_decay=0.01)
